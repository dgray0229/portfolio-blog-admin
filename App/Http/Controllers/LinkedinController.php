...
{
    //`First attempt at linkedin controller
    protected $app_id;
    protected $app_secret;
    protected $callback;
    protected $csrf;
    protected $ssl;
    public function __construct(string $app_id, string $app_secret, string $callback, bool $ssl = true)
    {
        $this->middleware('auth');
        $this->app_id = env('LINKEDIN_CLIENT_ID');
        $this->app_secret = env('LINKEDIN_CLIENT_ID');
